...
# Purpose   : perform spatial clustering using the BayesSpace workflow. Spatial clustering is performed per sample.
...
# Note: Regular clustering was used for the publication, because find cluster markers only runs for regular spot-level clustering. 
# Enhanced_sce with subspots is only required to run "fig2b_enhanced_gene_expr.ipynb"
